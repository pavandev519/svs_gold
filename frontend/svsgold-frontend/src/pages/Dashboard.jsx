...
export default function Dashboard({ loginData, onLogout }) {
    ...
    useEffect(() => {
        if (currentPage === 'enquiry' && !canAccessEnquiry) {
            setCurrentPage(canAccessApplications ? 'applications' : 'profile')
        }

        if (currentPage === 'applications' && !canAccessApplications) {
            setCurrentPage(canAccessEnquiry ? 'enquiry' : 'profile')
        }
    }, [currentPage, canAccessApplications, canAccessEnquiry])
    ...
    /* ================================================================ */
    const menuItems = [
        ...(canAccessApplications ? [{ id: 'applications', label: 'Applications', icon: FileText, color: 'text-amber-700' }] : []),
        ...
        text-white transition-all duration-300 shadow-2xl overflow-hidden`}
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-auto p-8">
                    {currentPage === 'applications' && canAccessApplications && (
                                        ...
                                        <div className="p-8">
                                            ...
                                            <div className="flex flex-col md:flex-row gap-3 mb-6">
                                                <button
                                                    ...
                                                    className={`flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-semibold transition-all duration-300 ${customerMode === 'existing' ? 'text-white shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                                        }`}
                                                ...
                                                <button
                                                    ...
                                                    className={`flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-semibold transition-all duration-300 ${customerMode === 'new' ? 'text-white shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                                        }`}
                                                ...
                                                <>
                                                    <div className="flex gap-3 mb-6">
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold transition-all duration-300 ${searchType === 'mobile' ? 'text-white shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                                                }`}
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold transition-all duration-300 ${searchType === 'email' ? 'text-white shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                                                }`}
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                                                    <div>
                                                        ...
                                                        <select
                                                            ...
                                                            className={`w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-800 text-sm focus:outline-none focus:border-amber-500 transition-all ${loginData?.branchName && !loginData?.isAdmin
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-amber-100 text-sm mt-1">
                            Invoice, settlement, and executive charges overview
                        </p>
                    </div>
    ...
    <div className="grid lg:grid-cols-12 gap-5 items-start">
                        ...
                        <button
                            ...
                            style={
                                ...
                                p
                                    ? {
                                          background:
                                              "linear-gradient(135deg,#7A4E0B,#A9741F,#D4A437)",
                                      }
                                    : {}
                            }
                        >
        ...
        <div className="lg:col-span-3 flex justify-end">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-5 rounded-3xl border border-[#E7D3A4] shadow-sm">
            ...
            {/* TABLE */}
            <div className="bg-white rounded-3xl border border-[#E7D3A4] shadow-sm overflow-x-auto overflow-y-auto max-h-[56vh]">
                <table className="min-w-[1200px] w-full text-sm divide-y divide-gray-200">
                    <thead className="bg-[#B68A2E] text-white">
                        <tr>
                            ...
                            <th className="sticky top-0 z-10 px-4 py-3 text-left text-xs uppercase tracking-[0.12em]">Wt Before</th>
                            <th className="sticky top-0 z-10 px-4 py-3 text-left text-xs uppercase tracking-[0.12em]">Wt After</th>
                            <th className="sticky top-0 z-10 px-4 py-3 text-left text-xs uppercase tracking-[0.12em]">Purity</th>
                            <th className="sticky top-0 z-10 px-4 py-3 text-left text-xs uppercase tracking-[0.12em]">Rate</th>
                            <th className="sticky top-0 z-10 px-4 py-3 text-left text-xs uppercase tracking-[0.12em]">Ded %</th>
                            <th className="sticky top-0 z-10 px-4 py-3 text-left text-xs uppercase tracking-[0.12em]">Gross</th>
                            <th className="sticky top-0 z-10 px-4 py-3 text-left text-xs uppercase tracking-[0.12em]">Net</th>
                            <th className="sticky top-0 z-10 px-4 py-3 text-left text-xs uppercase tracking-[0.12em]">Executive Charges</th>
                        </tr>
                    </thead>
                            ...
                            filteredItems.map((i) => {
                                ...
                                return (
                                    <tr key={i.invoice_item_id} className="border-b even:bg-gray-50 hover:bg-gray-100">
                                        ...
                                        <td className="px-4 py-3 whitespace-nowrap">{i.weight_before_melting}</td>
                                        <td className="px-4 py-3 whitespace-nowrap">{i.weight_after_melting}</td>
                                        <td className="px-4 py-3 whitespace-nowrap">{i.purity_after_melting}%</td>
                                        <td className="px-4 py-3 whitespace-nowrap">{cur(i.gold_rate_per_gm)}</td>
                                        <td className="px-4 py-3 whitespace-nowrap">{i.deduction_percentage}%</td>
                                        <td className="px-4 py-3 whitespace-nowrap">{cur(i.gross_amount)}</td>
                                        <td className="px-4 py-3 whitespace-nowrap">{cur(i.net_amount)}</td>
                                        <td className="px-4 py-3 whitespace-nowrap">{cur(exec)}</td>
                                    </tr>
                                );
                            })
                        )}
                                    ...
                                    <div className="flex items-start gap-4 flex-1">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-3 flex-wrap">
                                                ...
                                                <span className={`px-3 py-1 rounded-full text-xs font-bold border ${est.status === 'ESTIMATED' ? 'bg-green-100 text-green-700 border-green-200' : 'bg-amber-100 text-amber-700 border-amber-200'
                                                    }`}>{est.status}</span>
                                            </div>
