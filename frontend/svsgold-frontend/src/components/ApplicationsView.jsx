...
//                   <DetailField icon={<Hash size={16} className="text-amber-600" />} label="Mobile" value={detailData.application.mobile || '—'} />
...
//                       <DetailField icon={<User size={16} className="text-amber-600" />} label="Authorized Person" value={detailData.pledge_details.authorized_person || '—'} />
...
//         {detailLoading && (
//           <div className="flex items-center justify-center h-64">
//             <Loader size={40} className="text-amber-700 animate-spin mx-auto" />
//           </div>
//         )}
...
//               <div className="bg-gradient-to-r from-amber-700 to-amber-700 px-8 py-5 flex items-center justify-between">
//                 <div>
...
//                 </button>
//               ) : (
//                 <button onClick={() => setViewMode('pdf')} className="flex items-center gap-3 px-8 py-3.5 bg-gradient-to-r from-amber-700 to-amber-700 hover:from-amber-800 hover:to-amber-800 text-white font-bold rounded-xl shadow-lg shadow-amber-600/30 transition-all">
//                   <FileDown size={20} /> View / Download Application PDF
//                 </button>
//               )}
//             </div>
...
//   const formatted = suffix === '%' ? `${amount || 0}%` : `₹${Number(amount || 0).toLocaleString('en-IN')}`
//   return (
//     <div className={`rounded-xl p-4 text-center ${highlight ? 'bg-gradient-to-br from-amber-50 to-amber-50 border-2 border-amber-200' : 'bg-gray-50 border border-gray-100'}`}>
//       <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">{label}</p>
//       <p className={`text-lg font-bold mt-1 ${highlight ? 'text-amber-800' : 'text-gray-800'}`}>{formatted}</p>
//     </div>
//   )
