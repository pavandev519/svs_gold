...
class PaymentInvoiceItemCreateRequest(BaseModel):
    ...
    weight_before_melting: Optional[Decimal] = None
    weight_after_melting: Optional[Decimal] = None

    purity_after_melting: Optional[Decimal] = None
    gold_rate_per_gm: Optional[Decimal] = None

    gross_amount: Optional[Decimal] = None
    deductions_amount: Optional[Decimal] = None
    net_amount: Decimal
